/**
 * PÁGINA DE INTEGRACIONES - Dashboard Funcional
 * Muestra estado de conexiones y permite gestionar integraciones
 */
...
import { 
  Check, MessageSquare, Link2, Calendar, 
    ...
    <div className="space-y-6 p-4 md:p-6 pb-24 md:pb-6">
      ...
      <Card className="bg-primary/5 border-primary/10">
        <CardContent className="p-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <Button variant="outline" onClick={() => navigate('/integraciones-dashboard#suggest')}>
