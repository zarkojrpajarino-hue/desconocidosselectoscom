...
export interface PracticarAPIResponse<T> {
  data: T | null;
  error: string | null;
}

export type GuiaResponse = PracticarAPIResponse<Guia>;
export type PlaybookResponse = PracticarAPIResponse<Playbook>;
export type SimuladorResponse = PracticarAPIResponse<Simulador>;

// ============================================================================
// TYPE GUARDS
// ============================================================================

export function isGuia(data: unknown): data is Guia {
  return (
    typeof data === 'object' &&
    data !== null &&
    'id' in data &&
...
export function isPlaybook(data: unknown): data is Playbook {
  return (
    typeof data === 'object' &&
    data !== null &&
    'id' in data &&
...
export function isSimulador(data: unknown): data is Simulador {
  return (
    typeof data === 'object' &&
    data !== null &&
    'id' in data &&
