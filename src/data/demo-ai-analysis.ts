...
export const DEMO_AI_ANALYSIS: AIAnalysisResult = {
  ...
  financial_health: {
    ...
    charts: {
      revenue_vs_expenses: [
        { month: 'Ene', revenue: 98500, expenses: 78200 },
        { month: 'Feb', revenue: 105200, expenses: 81400 },
        { month: 'Mar', revenue: 112800, expenses: 84100 },
        { month: 'Abr', revenue: 118400, expenses: 85900 },
        { month: 'May', revenue: 121700, expenses: 87300 },
        { month: 'Jun', revenue: 127500, expenses: 89200 },
      ],
      margin_evolution: [
        { month: 'Ene', margin: 20.6 },
        { month: 'Feb', margin: 22.6 },
        { month: 'Mar', margin: 25.4 },
        { month: 'Abr', margin: 27.4 },
        { month: 'May', margin: 28.2 },
  ...
  growth_analysis: {
    ...
    charts: {
      customer_growth: [
        { month: 'Ene', customers: 156, new: 28, churned: 8 },
        { month: 'Feb', customers: 168, new: 24, churned: 12 },
        { month: 'Mar', customers: 184, new: 32, churned: 16 },
        { month: 'Abr', customers: 198, new: 26, churned: 12 },
        { month: 'May', customers: 215, new: 35, churned: 18 },
        { month: 'Jun', customers: 234, new: 38, churned: 19 },
      ],
      revenue_by_product: [
